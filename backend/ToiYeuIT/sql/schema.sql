...
>>>>>>> ade164476dc1604d41e56e58a755a2add17e5306
...
CREATE TABLE test_collection (
                                 ...
                                 description varchar(255),
                                 title       varchar(255),
                                 CONSTRAINT test_collection_ibfk_2 FOREIGN KEY (skill_id) REFERENCES skill (id)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE test (
                      ...
                      title              varchar(255),
                      enabled            bit DEFAULT b'1',
                      CONSTRAINT FK34np1jcju9km4vaswfl1oy9cp FOREIGN KEY (test_collection_id)
                          REFERENCES test_collection (id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE question_cluster (
                                  ...
                                  part      int NOT NULL,
                                  test_id   int,
                                  CONSTRAINT FKkd53425gk00tlq2lije4tdyll FOREIGN KEY (test_id)
                                      REFERENCES test (id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE question (
                          ques_id bigint auto_increment PRIMARY KEY,
                          description varchar(255),
                          correct_ans varchar(255) NOT NULL,
                          question_scope enum ('TEST', '') DEFAULT 'TEST' NOT NULL,
                          question_type enum ('MULTICHOICE', 'FILLING_BLANK') DEFAULT 'MULTICHOICE' NOT NULL,
                          ...
                          img_src varchar(255),
                          question_cluster_id int,
                          CONSTRAINT question_cluster__fk FOREIGN KEY (question_cluster_id)
                              REFERENCES question_cluster (id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE multichoice_detail (
                                    ...
                                    answer_key enum ('A', 'B', 'C', 'D') NOT NULL,
                                    answer_description varchar(255),
                                    CONSTRAINT multichoice_detail_ibfk_1 FOREIGN KEY (ques_id)
                                        REFERENCES question (ques_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE grammar (
                         ...
                         created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                         updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                         CONSTRAINT fk_grammar_lesson FOREIGN KEY (lesson_id)
...
CREATE TABLE grammar_quiz (
                              ...
                              created_at      datetime(6),
                              updated_at      datetime(6),
                              CONSTRAINT fk_quiz_grammar FOREIGN KEY (grammar_id)
                                  REFERENCES grammar (grammar_id) ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE quiz_option (
                             ...
                             created_at      datetime(6),
                             updated_at      datetime(6),
                             CONSTRAINT fk_option_question FOREIGN KEY (grammar_quiz_id)
                                 REFERENCES grammar_quiz (grammar_quiz_id) ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE quiz_user_submission (
                                      ...
                                      CONSTRAINT fk_submission_option FOREIGN KEY (selected_option_id)
                                          REFERENCES quiz_option (option_id) ON DELETE CASCADE,
...
CREATE TABLE test_detail (
                             ...
                             part        int NOT NULL,
                             indexx     int NOT NULL,
                             CONSTRAINT test_detail_ibfk_1 FOREIGN KEY (belong_to)
                                 REFERENCES test (id) ON DELETE CASCADE,
                             CONSTRAINT test_detail_ibfk_2 FOREIGN KEY (question_id)
                                 REFERENCES question (ques_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE test_submission (
                                 ...
                                 score            float,
                                 CONSTRAINT test_submission_ibfk_1 FOREIGN KEY (test_id)
                                     REFERENCES test (id) ON UPDATE CASCADE ON DELETE CASCADE,
                                 CONSTRAINT test_submission_ibfk_2 FOREIGN KEY (last_answered_by)
...
CREATE TABLE test_result (
                             ...
                             question_id bigint,
                             submit_id   bigint,
                             CONSTRAINT FK787s15vwqnuckvarfil6r6wsk FOREIGN KEY (question_id)
                                 REFERENCES question (ques_id) ON UPDATE CASCADE ON DELETE CASCADE,
                             CONSTRAINT FKqw150dx9te5yl1xh95r05wa0h FOREIGN KEY (submit_id)
                                 REFERENCES test_submission (submission_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE order_course (
                              ...
                              CONSTRAINT order_course_ibfk_1 FOREIGN KEY (user_id) REFERENCES user (user_id),
                              CONSTRAINT order_course_ibfk_2 FOREIGN KEY (course_id) REFERENCES course (course_id)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE enrollment (
                            ...
                            course_id   int,
                            user_id     bigint,
                            CONSTRAINT FKbhhcqkw1px6yljqg92m0sh2gt FOREIGN KEY (course_id)
                                REFERENCES course (course_id) ON UPDATE CASCADE ON DELETE CASCADE,
                            CONSTRAINT FKgpuyid9pbfpxghv9vyhb0ictd FOREIGN KEY (user_id)
                                REFERENCES user (user_id) ON UPDATE CASCADE ON DELETE CASCADE
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
